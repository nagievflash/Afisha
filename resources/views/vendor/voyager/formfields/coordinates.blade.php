            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-5" v-if="showAutocomplete">
                        <label class="control-label" style="font-weight:bold;">Поиск организации в справочнике</label>
                        <input
                            class="form-control"
                            type="text"
                            placeholder="Введите название организации и выберите из списка"
                            id="places-autocomplete"
                            v-on:keypress="onInputKeyPress($event)"
                        />
                    </div>
                </div>
                <div class="col-md-2 d-none" v-if="showLatLng" style="display:none">
